...
<html> 
	...
	<head> 
		...
		<script type="text/javascript">
			$(function() {
				var orgcode='${orgCode}';
				var id='com.ecarinfo.weichexin:ec-weichexin-httpserver:jar:0.0.1-SNAPSHOT';
		 	});
			...
			<div data-role="content"> 
				<form action="/myfs/add" method="post" id="settingForm">
					<div class="ui-grid-a">
			    		...
			    		<div class="ui-block-b" style="width:60%;"><input type="text" name="email" id="email" placeholder="请输入您的常用邮箱" /></div>
			    		...
			    		<div class="ui-block-b" style="width:60%;"><input type="text" name="carNo" id="carNo" placeholder="请输入您的车牌号" /></div>
					</div>
