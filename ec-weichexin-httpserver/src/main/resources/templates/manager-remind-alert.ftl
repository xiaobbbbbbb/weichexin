  ...
  $(function() {
 	...
 	function submitForm(){
					...
					$.ajax({
		                ...
		                data:$('#upremindForm').serialize(),// 你的formid
		                async: false,
...
<div data-role="page" id="home"> 
  <div data-role="content"> 
	<form name="upremindForm" id="upremindForm">
		<label for="bydate">保养日期：</label>
         <input type="text" data-role="datebox"   id="bydate" name="bydate" value="${bydate}"/>
         <label for="bymiles">保养里程：</label>
         <input type="text" data-role="datebox"   id="bymiles" name="bymiles" value="${mileage}"/>
         <label for="njdate">年检日期：</label>
         <input type="text" data-role="datebox"   id="njdate" name="njdate" value="${yearCheckDate}"/>
         <label for="xbdate">续保日期：</label>
         <input type="text" data-role="datebox"   id="xbdate" name="xbdate" value="${xbdate}"/>
         <label for="licenseDate">驾照年审：</label>
         <input type="text" data-role="datebox"   id="licenseDate" name="licenseDate" value="${licenseYearDate}"/>
         <label for="changedate">驾照换证：</label>
         <input type="text" data-role="datebox"   id="changedate" name="changedate" value="${changeDate}"/>
