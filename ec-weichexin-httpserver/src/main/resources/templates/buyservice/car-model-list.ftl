...
<head> 
	...
	function showmodel(e){
			window.location.href="/buy/showModel?modelId="+e+"&openId=${openId}&orgId=${orgId}";
		}
	</script>
	<style>
		div{
	...
	<div> 
		...
		<table cellspacing="0" cellpadding="0" style="margin-left:2%;margin-top: 10px;margin-bottom: 5px;">
	  		<tr>
				<td>
					<#if imageUrl??>
						<img style="max-width:120px;width:120px;height:80px;" src='${imageUrl}'/>
					<#else>
						<img  style="max-width:120px;width:120px;height:80px;" src='/static/wcx/no_image1.png'/>
			  ...
			  <li style="border-bottom: solid 1px rgba(197, 196, 177, 0.88);list-style-type: none">
			  	<table style="margin-top: 5px;margin-bottom: 5px;width:100%;">
					...
					<td align="left"  >
						...
						<b onclick= "showmodel(${dto.id?c})" >${dto.year}款  ${dto.name}
						<#if dto.hasYouhui>
						...
						<br/>
						<span  style="color:#000000;padding-top:113px;">官方价：${dto.refPrice}万</span><br/>
						<span style="color:#FF7F50;padding-top:3px;">本店价：${dto.ourPrice}万</span><br/>
						</b>
					</td>
